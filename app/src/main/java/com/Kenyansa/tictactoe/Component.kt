...
import com.Kenyansa.tictactoe.ui.theme.Aqua
import com.Kenyansa.tictactoe.ui.theme.GreenishYellow
 ...
 Canvas(modifier = Modifier
    ...
    drawLine(
     ...
     drawLine(
         ...
         strokeWidth = 5f,
         cap = StrokeCap.Round,
         start = Offset(y = size.width*1/3, x = 0f),
         end = Offset(y = size.width*1/3, x = size.height)
     )
     drawLine(
         color = Color.Gray,
         strokeWidth = 5f,
         cap = StrokeCap.Round,
         start = Offset(y = size.width*2/3, x = 0f),
         end = Offset(y = size.width*2/3, x = size.height)
     )
 }
}
